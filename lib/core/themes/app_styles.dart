...
class AppStyles {
  ...
  static final TextStyle black14SemiBold = _createStyle(
    fontSize: 14.sp,
    fontWeight: semiBold,
    color: AppColors.black,
  );

  static final TextStyle black20SemiBold = _createStyle(
    fontSize: 20.sp,
    fontWeight: semiBold,
    color: AppColors.black,
  );
  ...
  static final TextStyle primary12SemiBold = _createStyle(
    fontSize: 12.sp,
    fontWeight: semiBold,
  ...
  static final TextStyle grayDark14Medium = _createStyle(
    fontSize: 14.sp,
    fontWeight: medium,
    color: AppColors.gray2,
  );
  ...
  static final TextStyle black18SemiBold = _createStyle(
    fontSize: 18.sp,
    fontWeight: semiBold,
    color: AppColors.black,
  );
