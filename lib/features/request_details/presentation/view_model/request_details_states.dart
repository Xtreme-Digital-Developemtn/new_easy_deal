...
import 'package:easy_deal/features/request_details/data/models/update_status_model.dart';
...
class UpdateRequestStatusLoadingState extends RequestDetailsStates {}

class UpdateRequestStatusSuccessState extends RequestDetailsStates {
  final UpdateStatusModel model;
  UpdateRequestStatusSuccessState(this.model);
}

class UpdateRequestStatusErrorState extends RequestDetailsStates {
  final String error;
  UpdateRequestStatusErrorState(this.error);
}
