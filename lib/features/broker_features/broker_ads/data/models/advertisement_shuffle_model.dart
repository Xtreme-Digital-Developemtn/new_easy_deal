...
class AdvertisementShuffleModel {
  String? status;
  String? message;
  List<Data>? data;
  int? count;

  AdvertisementShuffleModel({this.status, this.message, this.data, this.count});

  AdvertisementShuffleModel.fromJson(Map<String, dynamic> json) {
    status = json["status"];
...
class AdditionalDetails {
  ...
  AdditionalDetails({this.notes, this.unitFacing, this.legalStatus});
