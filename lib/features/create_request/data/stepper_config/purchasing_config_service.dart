...
class PurchasingConfigService {
  ...
  List<InputConfig> _createPrimaryInsideCompoundPurchasingLocationInputs() {
    return [
      InputConfig(
        step: 2,
        name: 'compoundName',
  ...
  List<InputConfig> _createPrimaryInsideCompoundPurchasingFinancialInputs() {
    return [
      const InputConfig(
        step: 4,
        name: 'averageUnitPriceMin',
  ...
  List<InputConfig> _createPrimaryInsideCompoundPurchasingUnitInformationInputs({required bool includeRooms}) {
    final baseInputs = <InputConfig>[
      const InputConfig(
        step: 3,
        name: 'unitAreaMin',
  ...
  List<InputConfig> _createResaleInsideCompoundPurchasingUnitInformationInputs() {
    return [
      const InputConfig(
        step: 3,
        name: 'unitAreaMin',
  ...
  List<InputConfig> _createResaleInsideCompoundPurchasingFinancialInputs() {
    return [
      const InputConfig(
        step: 4,
        name: 'averageUnitPriceMin',
  ...
  List<InputConfig> _createPrimaryInsideCompoundPurchasingConfig({
    ...
    return [
      ..._createPrimaryInsideCompoundPurchasingLocationInputs(),
      ..._createPrimaryInsideCompoundPurchasingUnitInformationInputs(includeRooms: includeRooms),
      ..._createPrimaryInsideCompoundPurchasingFinancialInputs(),
    ];
  }
    ...
    return [
      ...
      StepperConfiguration(
        ...
        inputs: [
          ...
          ..._createResaleInsideCompoundPurchasingUnitInformationInputs(),
          ..._createResaleInsideCompoundPurchasingFinancialInputs(),
        ],
      ),
      StepperConfiguration(
